...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.transaction_type_label = QtGui.QLabel(self.tab)
        self.transaction_type_label.setObjectName(_fromUtf8("transaction_type_label"))
        self.horizontalLayout_13.addWidget(self.transaction_type_label)
        spacerItem8 = QtGui.QSpacerItem(0, 60, QtGui.QSizePolicy.Maximum, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout_13.addItem(spacerItem8)
        self.Transaction_type_comboBox = QtGui.QComboBox(self.tab)
        self.Transaction_type_comboBox.setEnabled(True)
        self.Transaction_type_comboBox.setObjectName(_fromUtf8("Transaction_type_comboBox"))
        self.Transaction_type_comboBox.addItem(_fromUtf8(""))
        self.Transaction_type_comboBox.addItem(_fromUtf8(""))
        self.Transaction_type_comboBox.addItem(_fromUtf8(""))
        self.horizontalLayout_13.addWidget(self.Transaction_type_comboBox)
        self.verticalLayout_4.addLayout(self.horizontalLayout_13)
        self.horizontalLayout_12 = QtGui.QHBoxLayout()
        self.horizontalLayout_12.setObjectName(_fromUtf8("horizontalLayout_12"))
        self.with_draw_label = QtGui.QLabel(self.tab)
        self.with_draw_label.setObjectName(_fromUtf8("with_draw_label"))
        self.horizontalLayout_12.addWidget(self.with_draw_label)
        spacerItem9 = QtGui.QSpacerItem(120, 20, QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout_12.addItem(spacerItem9)
        self.with_draw_lineEdit = QtGui.QLineEdit(self.tab)
        self.with_draw_lineEdit.setObjectName(_fromUtf8("with_draw_lineEdit"))
        self.horizontalLayout_12.addWidget(self.with_draw_lineEdit)
        self.verticalLayout_4.addLayout(self.horizontalLayout_12)
        self.horizontalLayout_16 = QtGui.QHBoxLayout()
        self.horizontalLayout_16.setObjectName(_fromUtf8("horizontalLayout_16"))
        self.accounttype_label = QtGui.QLabel(self.tab)
        self.accounttype_label.setObjectName(_fromUtf8("accounttype_label"))
        self.horizontalLayout_16.addWidget(self.accounttype_label)
        ...
        self.account_label = QtGui.QLabel(self.tab)
        self.account_label.setObjectName(_fromUtf8("account_label"))
        self.horizontalLayout_15.addWidget(self.account_label)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.transaction_type_label.setText(_translate("MainWindow", "Transaction_Type", None))
        self.Transaction_type_comboBox.setItemText(0, _translate("MainWindow", "_select", None))
        self.Transaction_type_comboBox.setItemText(1, _translate("MainWindow", "withdraw", None))
        self.Transaction_type_comboBox.setItemText(2, _translate("MainWindow", "Deposit", None))
        self.with_draw_label.setText(_translate("MainWindow", "Withdraw", None))
        self.accounttype_label.setText(_translate("MainWindow", "Account Type", None))
        self.label.setText(_translate("MainWindow", "TextLabel", None))
        self.account_label.setText(_translate("MainWindow", "TextLabel", None))
        self.label_2.setText(_translate("MainWindow", "TextLabel", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("MainWindow", "Withdraw/Deposit", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MainWindow", "Transfer", None))
